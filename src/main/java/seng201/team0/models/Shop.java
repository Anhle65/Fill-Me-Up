...
public class Shop {
    ...
    public Shop(){
        ...
        defaultItems.addAll(List.of(new PurchasableItems("Upgrade time", 0, TIME_ENHANCEMENT[timeIndex], COST[timeIndex]),
                ...
                new PurchasableItems(TYPE_RESOURCES[towerRandomTypeIndexes.get(0)], new Tower(TYPE_RESOURCES[towerRandomTypeIndexes.get(0)], 1, 40, 20, 6, true, false )),
                new PurchasableItems(TYPE_RESOURCES[towerRandomTypeIndexes.get(1)], new Tower(TYPE_RESOURCES[towerRandomTypeIndexes.get(1)], 1, 40, 20, 6, true, false )),
                new PurchasableItems(TYPE_RESOURCES[towerRandomTypeIndexes.get(2)], new Tower(TYPE_RESOURCES[towerRandomTypeIndexes.get(2)], 1, 40, 20, 6, true, false ))
                ));
    }
